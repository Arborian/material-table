    ...
    function MTableHeader(props) {
        ...
        (0, _defineProperty2.default)(
            ...
            function (e) {
                ...
                var additionalWidth =
                    _this.state.lastAdditionalWidth +
                    e.clientX -
                    _this.state.lastX;
    ...
    (0, _createClass2.default)(MTableHeader, [
        ...
        },
        {
            ...
            value: function renderHeader() {
                ...
                var size =
                    this.props.options.padding === 'default'
                        ? 'medium'
                        : 'small';
                ...
                if (this.props.hasDetailPanel) {
                    if (this.props.detailPanelColumnAlignment === 'right') {
                        ...
                        headers.splice(
                            0,
                            0,
                            this.renderDetailPanelColumnCell(),
                        );
                    }
                }
