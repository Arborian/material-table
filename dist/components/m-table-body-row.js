    ...
    (0, _createClass2.default)(MTableBodyRow, [
            ...
            value: function renderColumns() {
                ...
                var mapArr = this.props.columns
                    .filter(function (columnDef) {
                        return (
                            !columnDef.hidden &&
                            !(columnDef.tableData.groupOrder > -1)
                        );
                    })
                    .sort(function (a, b) {
                        return (
                    ...
                    .map(function (columnDef, index) {
                        ...
                        if (
                            ...
                            _this2.props.data.tableData.editCellList.find(
                                function (c) {
                                    return (
                                        c.tableData.id ===
                            ...
                            return /*#__PURE__*/ React.createElement(
                                _this2.props.components.EditCell,
                                {
                                    ...
                                    onCellEditFinished:
                                        _this2.props.onCellEditFinished,
                            ...
                            return /*#__PURE__*/ React.createElement(
                                _this2.props.components.Cell,
                                {
                                    ...
                                    columnDef: (0, _objectSpread2.default)(
                                        {
                                            cellStyle:
                                                _this2.props.options.cellStyle,
                                        },
                                        columnDef,
                                    ),
                                    value: value,
                                    ...
                                    onCellEditStarted:
                                        _this2.props.onCellEditStarted,
                                    scrollWidth: _this2.props.scrollWidth,
                                },
                            );
                        }
        ...
        },
        {
            ...
            value: function renderActions() {
                ...
                var width =
                    actions.length * CommonValues.baseIconSize(this.props);
                return /*#__PURE__*/ React.createElement(
                    _TableCell.default,
                    {
                        size: size,
                        ...
                        (0, _extends2.default)(
                            {
                                size: size,
                                checked:
                                    this.props.data.tableData.checked === true,
                        ...
                        /*#__PURE__*/ React.createElement(
                            'div',
                            {
                                style: (0, _objectSpread2.default)(
                                    {
                                        width:
                                            42 * this.props.detailPanel.length,
                                        textAlign: 'center',
                                        display: 'flex',
                                    },
                                    this.props.options.detailPanelColumnStyle,
                ...
                if (
                    ...
                    return /*#__PURE__*/ React.createElement(
                        _TableCell.default,
                        {
                            ...
                            style: {
                                width:
                                    48 + 9 * (this.props.treeDataMaxLevel - 2),
                            },
                        },
                        /*#__PURE__*/ React.createElement(
                            _IconButton.default,
            ...
            value: function render() {
                ...
                return /*#__PURE__*/ React.createElement(
                    ...
                    this.props.data.tableData.childRows &&
                        ...
                        this.props.data.tableData.childRows.map(function (
                            data,
                            index,
                        ) {
                            if (data.tableData.editing) {
                                return /*#__PURE__*/ React.createElement(
                                    ...
                                    {
                                        columns: _this6.props.columns.filter(
                                            function (columnDef) {
