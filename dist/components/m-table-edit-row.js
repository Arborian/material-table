            ...
            value: function renderColumns() {
                ...
                var mapArr = this.props.columns
                    ...
                    .map(function (columnDef, index) {
                        var value =
                            typeof _this2.state.data[columnDef.field] !==
                            'undefined'
                        ...
                        if (
                            columnDef.editable === 'onAdd' &&
                            _this2.props.mode === 'add'
                        ) {
                            allowEditing = true;
                        }
                        ...
                        if (!columnDef.field || !allowEditing) {
                            ...
                            var EditComponent =
                                editComponent ||
                                _this2.props.components.EditField;
                            var error = {
                                isValid: true,
                                helperText: '',
                            };
                            ...
                            if (columnDef.validate) {
                                ...
                                switch (
                                    (0, _typeof2.default)(validateResponse)
                                ) {
                                    case 'object':
                            ...
                            return /*#__PURE__*/ React.createElement(
                                _TableCell.default,
                                {
                                    ...
                                    key: columnDef.tableData.id,
                                    align:
                                        ['numeric'].indexOf(columnDef.type) !==
                                        -1
                                            ? 'right'
                                            : 'left',
                                    style: getCellStyle(columnDef, value),
                                ...
                                /*#__PURE__*/ React.createElement(
                                    EditComponent,
                                    {
                                        ...
                                        onRowDataChange: function onRowDataChange(
                                            data,
                                        ) {
                                            _this2.setState(
                                                {
        ...
        },
        {
            ...
            value: function render() {
                ...
                if (
                    ...
                    var colSpan = this.props.columns.filter(function (
                        columnDef,
                    ) {
                        return (
                            !columnDef.hidden &&
                ...
                if (this.props.detailPanel) {
                    var aligment = this.props.options
