    ...
    (0, _createClass2.default)(MTableBody, [
        {
            ...
            value: function renderEmpty(emptyRowCount, renderData) {
                var rowHeight =
                    this.props.options.padding === 'default' ? 49 : 36;
                ...
                return renderData.map(function (data, index) {
                    if (data.tableData.editing || _this.props.bulkEditOpen) {
                        return /*#__PURE__*/ React.createElement(
                            ...
                            {
                                columns: _this.props.columns.filter(function (
                                    columnDef,
                                ) {
                                    return !columnDef.hidden;
                                }),
                        ...
                        return /*#__PURE__*/ React.createElement(
                            _this.props.components.Row,
                            {
                                ...
                                path: [
                                    index +
                                        _this.props.pageSize *
                                            _this.props.currentPage,
                                ],
                                onToggleDetailPanel:
                                    _this.props.onToggleDetailPanel,
                                onRowClick: _this.props.onRowClick,
                                isTreeData: _this.props.isTreeData,
                                onTreeExpandChanged:
                                    _this.props.onTreeExpandChanged,
                                onEditingCanceled:
                                    _this.props.onEditingCanceled,
                                onEditingApproved:
                                    _this.props.onEditingApproved,
                ...
                return renderData.map(function (groupData, index) {
                    return /*#__PURE__*/ React.createElement(
                        _this2.props.components.GroupRow,
                        {
                            ...
                            path: [
                                index +
                                    _this2.props.pageSize *
                                        _this2.props.currentPage,
                            ],
                            onGroupExpandChanged:
                                _this2.props.onGroupExpandChanged,
                            ...
                            onToggleDetailPanel:
                                _this2.props.onToggleDetailPanel,
                            onTreeExpandChanged:
                                _this2.props.onTreeExpandChanged,
                ...
                return /*#__PURE__*/ React.createElement(
                    ...
                    this.props.options.filtering &&
                        /*#__PURE__*/ React.createElement(
                            ...
                            {
                                columns: this.props.columns.filter(function (
                                    columnDef,
                                ) {
                                    return !columnDef.hidden;
                                }),
                                ...
                                actionsColumnIndex: this.props.options
                                    .actionsColumnIndex,
                                ...
                                localization: (0, _objectSpread2.default)(
                                    ...
                                    {
                                        dateTimePickerLocalization: this.props
                                            .localization
                                            .dateTimePickerLocalization,
                                    },
                                ),
                                ...
                                filterCellStyle: this.props.options
                                    .filterCellStyle,
                                filterRowStyle: this.props.options
                                    .filterRowStyle,
                                hideFilterIcons: this.props.options
                                    .hideFilterIcons,
