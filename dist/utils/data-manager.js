    ...
    function DataManager() {
        ...
        (0, _defineProperty2.default)(this, 'finishCellEditable', function (
            ...
            if (rowData.tableData.editCellList) {
                var index = rowData.tableData.editCellList.findIndex(function (
                    c,
                ) {
                ...
                _this.columns
                    ...
                    .forEach(function (columnDef) {
                        ...
                        if (columnDef.customFilterAndSearch) {
                            _this.filteredData = _this.filteredData.filter(
                                function (row) {
                                ...
                                _this.filteredData = _this.filteredData.filter(
                                    function (row) {
                                        ...
                                        if (
                                            ...
                                            if (type === 'date') {
                                                currentDateToCompare = (0,
                                                _format.default)(
                                                    currentDate,
                                                    'MM/dd/yyyy',
                                                );
                                                selectedDateToCompare = (0,
                                                _format.default)(
                                                    selectedDate,
                                                    'MM/dd/yyyy',
                                                );
                                    ...
                                    function (row) {
                                        ...
                                        return (
                                            ...
                                            value
                                                ...
                                                .toUpperCase()
                                                .includes(
                                                    tableData.filterValue.toUpperCase(),
                                                )
                                        );
                                    },
                                );
    ...
    (0, _createClass2.default)(DataManager, [
        {
            ...
            value: function setData(data) {
                ...
                this.data = data.map(function (row, index) {
                    row.tableData = (0, _objectSpread2.default)(
                        {},
                        row.tableData,
                        {
                            id: index,
            ...
            value: function changeRowSelected(checked, path) {
                ...
                var checkChildRows = function checkChildRows(rowData) {
                    if (rowData.tableData.childRows) {
                        rowData.tableData.childRows.forEach(function (
                            childRow,
                        ) {
            ...
            value: function changeAllSelected(checked) {
                ...
                if (this.isDataType('group')) {
                        ...
                        data.forEach(function (element) {
                            if (element.groups.length > 0) {
                                ...
                                element.data.forEach(function (d) {
                                    d.tableData.checked = d.tableData.disabled
                                        ? false
                                        : checked;
                                    selectedCount++;
                                });
                    ...
                    this.searchedData.map(function (row) {
                        row.tableData.checked = row.tableData.disabled
                            ? false
                            : checked;
                        return row;
                    });
        ...
        },
        {
            ...
            value: function changeTreeExpand(path) {
                var rowData = this.findDataByPath(this.sortedData, path);
                rowData.tableData.isTreeExpanded = !rowData.tableData
                    .isTreeExpanded;
            },
        },
        {
            ...
            value: function changeByDrag(result) {
                ...
                var groups = this.columns
                    ...
                    .sort(function (col1, col2) {
                        return (
                            col1.tableData.groupOrder -
                            col2.tableData.groupOrder
                        );
                    });
                ...
                if (
                    ...
                    for (
                        ...
                        numVisibleInRange < _end - start &&
                        effectiveEnd < sorted.length;
                        effectiveEnd++
                    ) {
                    ...
                    for (var _i = 0; _i < colsToMov.length; _i++) {
                        colsToMov[_i].tableData.columnOrder =
                            effectiveStart + _i;
                    }
        ...
        },
        {
            ...
            value: function groupData() {
                ...
                var tmpData = (0, _toConsumableArray2.default)(
                    this.searchedData,
                );
                var groups = this.columns
                    .filter(function (col) {
                    ...
                    var sortGroupData = function sortGroupData(list, level) {
                        list.forEach(function (element) {
                            if (element.groups.length > 0) {
                                ...
                                if (
                                    _this7.orderBy >= 0 &&
                                    _this7.orderDirection
                                ) {
                                    element.data = _this7.sortList(
                                        element.data,
                                    );
                                }
                            }
        ...
        },
        {
            ...
            value: function pageData() {
                this.pagedData = (0, _toConsumableArray2.default)(
                    this.sortedData,
                );
