    ...
    function MaterialTable(_props) {
        ...
        (0, _defineProperty2.default)(
            ...
            function (event) {
                ...
                _this.props.onChangePage &&
                    _this.props.onChangePage(0, pageSize);
                ...
                if (
                    ...
                    _this.setState(
                        ...
                        function () {
                            _this.props.editable
                                .onBulkUpdate(
                                    _this.dataManager.bulkEditChangedRows,
                                )
                                .then(function (result) {
                        ...
                        /*#__PURE__*/ React.createElement(
                            props.components.Header,
                            {
                                ...
                                dataCount: props.parentChildData
                                    ...
                                    : _this.state.columns.filter(function (
                                          col,
                                      ) {
                                ...
                                isTreeData:
                                    _this.props.parentChildData !== undefined,
        ...
        (0, _defineProperty2.default)(
            ...
            function (props, count) {
                ...
                for (
                    var i = 0;
                    i < Math.abs(count) && i < props.columns.length;
                    i++
                ) {
                    var colDef =
                        props.columns[
                            count >= 0 ? i : props.columns.length - 1 - i
                        ];
        ...
        },
        {
            ...
            value: function setDataManagerFields(props, isInit) {
                ...
                if (props && props.options.sorting !== false) {
                    defaultSortColumnIndex = props.columns.findIndex(function (
                        a,
                    ) {
                ...
                this.dataManager.setDefaultExpanded(
                    props.options.defaultExpanded,
                );
                ...
                var shouldReorder =
                    ...
                    (defaultSortColumnIndex !== this.dataManager.orderBy &&
                        !this.isRemoteData() &&
                        defaultSortDirection !==
                            this.dataManager.orderDirection);
                shouldReorder &&
                ...
                this.dataManager.changeDetailPanelType(
                    props.options.detailPanelType,
                );
            },
        },
        {
                        ...
                        calculatedProps.actions.push(function (rowData) {
                            return {
                                ...
                                tooltip: calculatedProps.editable.editTooltip
                                    ? calculatedProps.editable.editTooltip(
                                          rowData,
                                      )
                ...
                if (props.options.paging) {
                    ...
                    var currentPage = isOutsidePageNumbers
                        ? Math.min(
                              props.page,
                              Math.floor(
                                  props.totalCount / this.state.pageSize,
                              ),
                          )
                        : this.state.currentPage;
                                ...
                                /*#__PURE__*/ React.createElement(
                                    props.components.Pagination,
                                    {
                                        classes: {
                                            ...
                                            toolbar:
                                                props.classes.paginationToolbar,
                                            caption:
                                                props.classes.paginationCaption,
                                            selectRoot:
                                                props.classes
                        ...
                        props.options.toolbar &&
                            /*#__PURE__*/ React.createElement(
                                props.components.Toolbar,
                                {
                                    ...
                                    exportDelimiter:
                                        props.options.exportDelimiter,
                                    exportFileName:
                                        props.options.exportFileName,
                                    exportCsv: props.options.exportCsv,
                                    exportPdf: props.options.exportPdf,
                                    getFieldValue: this.dataManager
                                        .getFieldValue,
                                    ...
                                    toolbarButtonAlignment:
                                        props.options.toolbarButtonAlignment,
                                    searchFieldAlignment:
                                        props.options.searchFieldAlignment,
                                    searchAutoFocus:
                                        props.options.searchAutoFocus,
                                    searchFieldStyle:
                                        props.options.searchFieldStyle,
                                    searchFieldVariant:
                                        props.options.searchFieldVariant,
                                    title: props.title,
